...
export class SolicitarTurnoComponent implements OnInit {
    ...
    this.suscriptionList == this.svfUsuario.getEspecialidades().subscribe(data =>{
      ...
      data.forEach((element:any) => {
       ...
       /*  this.arrayEspecialistas = this.arrayEspecialistas.filter((obj) => {
        ...
        console.log("Turnos ", this.arrayEspecialistas);
  ...
  especialidadElegida(valorEmitidoRecibido:any)
  {
    ...
    this.getListEspecilistasHabilitados(this.especialidadIngresada);

    this.arrayEspecialistasFiltrado = this.listaUsuarioEspecilista;
  }

  getListEspecilistasHabilitados(param:string) {
  ...
  especialistaElegido(especialista:any)
  {
    ...
    // Enviar los Turnos de este Especilista elegido (Filtrado por email/especialidad)
  ...
  solicitarTurno()
  {
    if (this.especialidadIngresada != "" && this.especialistaIngresado != "" && this.fechaIngresada != "")
    {
      ...
      const datoTurno: TurnoPaciente = {
        ...
        estadoEspecialista:'',
        emailEspecilista:this.especialistaIngresado,
        apellidoPaciente:this.apellidoPaciente,
        nombrePaciente:this.nombrePaciente,
        apellidoEspecilista:this.apellidoEspecialista,
        nombreEspecilista:this.nombreEspecialista,
        fotoEspecilista:this.fotoEspecialista,
